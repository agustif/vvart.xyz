...
<Callout style={{background: "#000", color: "#FFF"}} icon="info">
<p style={{marginTop: -25}}>
To view the motion Checks contain, simply click on the Checks to make them move.
</p>
<table style={{marginLeft: -40, marginBottom: -24}}>
  <thead >
    <tr>
      <th style={{verticalAlign:"middle", textAlign:"center",color: "white"}}>Speed of Motion</th>
      <th style={{verticalAlign:"middle", textAlign:"center", color: "white"}}>Check #</th>
      <th style={{width: '50%', verticalAlign:"middle", textAlign:"center", color: "white"}}>Animated (Click to view)</th>
    </tr>
  </thead>
  <tbody>
      <tr style={{borderBottom: "none"}}>
        <td style={{verticalAlign:"middle", textAlign:"center"}}>0.5x speed</td>
        <td style={{verticalAlign:"middle", textAlign:"center", color: "white"}}><a style={{color: "white"}} target="_blank" href="https://opensea.io/assets/ethereum/0x036721e5a769cc48b3189efbb9cce4471e8a48b1/6129">6129</a></td>
        <td style={{textAlign:"center"}}><NFTEmbed tokenId="7f6b2561c2592151f52ef9c8081ecee3" /></td>
      </tr>
      <tr style={{borderBottom: "none"}}>
        <td style={{verticalAlign:"middle", textAlign:"center"}}>1x speed</td>
        <td style={{verticalAlign:"middle", textAlign:"center", color: "white"}}><a style={{color: "white"}} target="_blank" href="https://opensea.io/assets/ethereum/0x036721e5a769cc48b3189efbb9cce4471e8a48b1/7814">7814</a></td>
        <td><NFTEmbed tokenId="71c780cf3fe96920e3a4b02f4d2e9118" /></td>
      </tr>
      <tr style={{borderBottom: "none"}}>
        <td style={{verticalAlign:"middle", textAlign:"center"}}>2x speed</td>
        <td style={{verticalAlign:"middle", textAlign:"center",color: "white"}}><a style={{color: "white"}} target="_blank" href="https://opensea.io/assets/ethereum/0x036721e5a769cc48b3189efbb9cce4471e8a48b1/11755">11755</a></td>
        <td><NFTEmbed tokenId="d00780acdcea7436b2e150a6ce25e36b" /></td>
      </tr>
  </tbody>
</table>
</Callout>
