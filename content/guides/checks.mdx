...
At the request of his followers, Jack began minting these illustrations as NFTs in 2021, auctioning them on [foundation.app](http://foundation.app) ~ with [the following iconic illustration](https://foundation.app/@visualizevalue/foundation/25193) selling for a cool 74 ETH in March 2021 ~ over $110,000 at the time.
...
For a detailed breakdown of the thought process behind this decision to turn Checks into a generative art collection, we highly recommend reading Jacks [***transparency time thread***](https://twitter.com/jackbutcher/status/1611726527590187016?s=20)<Icons.arrowDown className="mx-auto" />
<Callout type="info">
Click on the tweet to read the full therad 🧵
