...
<Accordion title="A guide to creating new Checks" readingTimeInMinutes="5">
  <article className="prose">
    ...
    <Image src="/images/guides/checks/create-checks.png" alt="Check creation process visualized" className="rounded-lg"  />
    ...
    <Image src="/images/guides/checks/choose-color.jpeg" alt="Checks migrate flow" className="rounded-lg" />
